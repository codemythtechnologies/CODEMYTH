    ...
    <section className="hero" id="home">
      ...
      <div className="hero-stage">
        ...
        <div className="hero-content" id="heroContent" ref={contentRef}>
          <div className="eyebrow"><div className="eyebrow-dot" /><span>CODEMYTH TECHNOLOGIES</span></div>
          <h1 className="hero-h1-enterprise">Build software<br />that moves your<br /><em>business forward</em>.</h1>
          <p className="lead">
            Full-stack engineering, AI systems and digital products built for real-world production — not demos.
          </p>
          ...
          <div className="badge-row" style={{ padding: "28px 0 0" }}>
            <div className="info-chip"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4.5 8-11V5l-8-3-8 3v6c0 6.5 8 11 8 11z" /></svg>MSME registered — India</div>
