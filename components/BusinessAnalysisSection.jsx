...
const CHECK = (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
    <path d="M3 8.5L6.2 12L13 4" stroke="#FF8A4C" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
const CHECK_SM = (
...
const BA_CARDS = [
  {
    ...
    icon: <svg width="26" height="26" viewBox="0 0 26 26" fill="none"><circle cx="11" cy="11" r="7" stroke="#FF5500" strokeWidth="1.6" /><path d="M16.2 16.2L22 22" stroke="#FF8A4C" strokeWidth="1.8" strokeLinecap="round" /></svg>,
  },
  {
    ...
    icon: <svg width="26" height="26" viewBox="0 0 26 26" fill="none"><rect x="4" y="4" width="18" height="18" rx="3" stroke="#FF8A4C" strokeWidth="1.6" /><path d="M8 10h10M8 14h6" stroke="#FF8A4C" strokeWidth="1.6" strokeLinecap="round" /></svg>,
  },
  {
    ...
    icon: <svg width="26" height="26" viewBox="0 0 26 26" fill="none"><circle cx="13" cy="13" r="9" stroke="#FF5500" strokeWidth="1.6" /><path d="M13 8v5l3.5 2" stroke="#FF5500" strokeWidth="1.6" strokeLinecap="round" /></svg>,
  },
  {
    ...
    icon: <svg width="26" height="26" viewBox="0 0 26 26" fill="none"><path d="M3 21V13M9 21V7M15 21V11M21 21V4" stroke="#FF8A4C" strokeWidth="1.8" strokeLinecap="round" /></svg>,
  },
  {
    ...
    icon: <svg width="26" height="26" viewBox="0 0 26 26" fill="none"><path d="M13 3l3.5 7.2L24 11.3l-5.5 5.4L19.8 24 13 20.2 6.2 24l1.3-7.3L2 11.3l7.5-1.1L13 3z" stroke="#FF5500" strokeWidth="1.5" strokeLinejoin="round" /></svg>,
  },
  {
    ...
    icon: <svg width="26" height="26" viewBox="0 0 26 26" fill="none"><rect x="4" y="4" width="18" height="18" rx="3" stroke="#FF8A4C" strokeWidth="1.6" /><path d="M9 13h8M13 9v8" stroke="#FF8A4C" strokeWidth="1.6" strokeLinecap="round" /></svg>,
  },
];

const LEGEND = [
  { color: "#FF5500", label: "Idea Validation & Research — 43%" },
  { color: "#FF8A4C", label: "PRD & Requirements — 29%" },
  { color: "#CC4400", label: "MVP Roadmapping — 21%" },
  { color: "#9C9CA3", label: "Business Model & GTM — 7%" },
];

const HBARS = [
  { label: "Idea Validation", value: 96, color: "#FF5500" },
  { label: "PRD & Specs", value: 92, color: "#FF8A4C" },
  { label: "MVP Roadmapping", value: 94, color: "#CC4400" },
...
export default function BusinessAnalysisSection({ onOpenBAConsult }) {
  ...
  useEffect(() => {
    // Was gated behind framer-motion's `useInView` (chartsRef); same
    // unreliable-IntersectionObserver issue found elsewhere in this app,
    // so it's dropped in favour of running on mount, which is guaranteed
    // to fire.
          ...
          <Reveal className="ba-mock">
            ...
            <div className="ba-chart-card">
              <svg viewBox="0 0 300 110" xmlns="http://www.w3.org/2000/svg">
                ...
                <rect x="122" y="20" width="18" height="80" rx="3" fill="#FF5500" />
                ...
                <polyline points="19,50 47,35 75,25 103,40 131,15 159,30 187,10"
                  fill="none" stroke="#FF8A4C" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
                <circle cx="131" cy="15" r="4" fill="#FF8A4C" />
              </svg>
            </div>
          ...
          <div className="ba-chart-grid">
            ...
            <div className="ba-chart-panel">
              ...
              <svg viewBox="0 0 220 220" className="ba-donut">
                ...
                <circle className="ba-arc" style={{ "--len": "150.7" }} cx="110" cy="110" r="80" fill="none" stroke="#FF5500" strokeWidth="26" strokeDashoffset="0" strokeLinecap="round" transform="rotate(-90 110 110)" />
                <circle className="ba-arc" style={{ "--len": "100.5" }} cx="110" cy="110" r="80" fill="none" stroke="#FF8A4C" strokeWidth="26" strokeDashoffset="-150.7" strokeLinecap="round" transform="rotate(-90 110 110)" />
                <circle className="ba-arc" style={{ "--len": "75.4" }} cx="110" cy="110" r="80" fill="none" stroke="#CC4400" strokeWidth="26" strokeDashoffset="-251.2" strokeLinecap="round" transform="rotate(-90 110 110)" />
            ...
            <div className="ba-chart-panel">
              ...
              <svg viewBox="0 0 260 150" className="ba-trend">
                ...
                <path className="ba-trend-line" d="M20,90 L70,70 L120,60 L170,38 L220,28"
                  fill="none" stroke="#FF8A4C" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
                ...
                <defs>
                  <linearGradient id="baAreaFill" x1="0" y1="0" x2="0" y2="1">
                    ...
                    <stop offset="97.9%" stopColor="#FF8A4C" stopOpacity="0" />
                  </linearGradient>
                </defs>
                <circle className="ba-pt" cx="20" cy="90" r="3.2" fill="#FF8A4C" />
                <circle className="ba-pt" cx="70" cy="70" r="3.2" fill="#FF8A4C" />
                <circle className="ba-pt" cx="120" cy="60" r="3.2" fill="#FF8A4C" />
                <circle className="ba-pt" cx="170" cy="38" r="3.2" fill="#FF8A4C" />
                <circle className="ba-pt" cx="220" cy="28" r="4" fill="#FF8A4C" stroke="#08080a" strokeWidth="2" />
