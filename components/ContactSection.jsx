...
export default function ContactSection() {
  ...
  } = useForm({ resolver: zodResolver(contactClientSchema), defaultValues: { stage: "", need: "", phone: "", message: "" } });
      ...
      <div className="contact">
          ...
          <div className="contact-info">
            ...
            {CONTACT_PHONES.map((p) => (
              <a key={p.value} className="contact-item clickable" href={p.href}>
                ...
                {p.value}
                <span style={{ marginLeft: 6, fontSize: 10, letterSpacing: 0.4, textTransform: "uppercase", color: "var(--text-muted)" }}>{p.label}</span>
              </a>
            ))}
        ...
        <Reveal as="form" className="contact-form" onSubmit={handleSubmit(onSubmit)} noValidate delay={0.1}>
          ...
          */}
          ...
          <Reveal as="div" className="field-row" delay={0.17}>
            <div className={`field${errors.phone ? " error" : ""}`}>
              <label htmlFor="cf-phone">Your phone number (optional)</label>
              <input id="cf-phone" type="tel" placeholder="+91 98765 43210" autoComplete="tel" {...register("phone")} />
              <div className="field-err">{errors.phone?.message}</div>
            </div>
            <div className="field" />
          </Reveal>
